  ...
  return (
    <>
                ...
                <div className="flex gap-4 md:flex-col">
                  <li className="text-sm text-[#777] cursor-pointer relative group">
                    <span className="relative">
                      Womens
                      <span className="absolute inset-x-0 top-5 w-0 h-[2px] bg-[#FF4C3B] transition-all duration-500 group-hover:w-[100%]"></span>
                    </span>
                  </li>
                  <li className="text-sm text-[#777] cursor-pointer relative group">
                    <span className="relative">
      ...
      <div className="max-w-[1260px] mx-auto py-5">
        <p className="text-sm text-[#777]">
          &copy; 2024-25 E-Commerece powered by Feshion
        </p>
      </div>
    </>
  );
